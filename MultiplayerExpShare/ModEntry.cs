...
namespace MultiplayerExpShare
{
    internal class ModEntry : Mod
    {
        ...
        /// <summary>
        /// Color used for Foraging exp particle, yellowish green
        /// </summary>
        internal readonly Color ForagingColor =     new Color(154, 205, 50);
        /// <summary>
        ...
        /// </summary>
        internal readonly Color CombatColor =       new Color(0f, 220, 230);
